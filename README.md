...
> 版本：2.0 | 更新日期：2026-05-28 | 适用 WeChat 4.x | Windows 10/11
...
3. [Web 界面功能详解](#3-web-界面功能详解)
   ...
   - [3.9 工具 — 提取密钥与解密数据库](#39-工具--提取密钥与解密数据库)
...
```
第一步：双击 wechat_exp.exe 启动程序
第二步：在自动打开的网页中，点击"一键备份"
```
...
| ② 解密 | "正在解密数据库..." | 解密微信加密的数据库文件 | 10-60 秒 |
| ③ 迁移 | "正在迁移媒体文件..." | 复制图片、视频、语音、文件 | 1-5 分钟 |
| ④ 索引 | "正在构建索引..." | 建立聊天记录统一索引 | 10-30 秒 |

> **提示**：整个备份过程通常需要 2-5 分钟，具体时间取决于微信数据量的大小。
